...
def build_from_sketch(notes: str = "") -> str:
    ...
    return (
        ...
        "overlap, computed from geometry. Aim for clash_count 0 (touching is fine). "
        "Only after the math checks out, call `ironcad_capture_view` ONCE as a final "
        "visual confirmation — not after every part.\n"
